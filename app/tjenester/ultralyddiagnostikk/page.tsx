...
const SLUG = "ultralyddiagnostikk";
...
export default function UltralydPage() {
  ...
  return (
    <>
      ...
      <CtaBanner heading="Bestill ultralydundersøkelse i dag" body="Ring oss direkte eller bruk kontaktskjemaet — vi finner en tid som passer." />
    </>
  );
}
