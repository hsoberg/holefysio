...
const SLUG = "psykomotorisk-fysioterapi";
...
export default function PsykomotoriskPage() {
  ...
  return (
    <>
      ...
      <FaqSection items={service.faq} heading="Vanlige spørsmål om psykomotorisk fysioterapi" />
      <CtaBanner heading="Ta kontakt for en samtale" body="Ring oss eller bruk kontaktskjemaet — vi finner en tid som passer deg." />
    </>
  );
}
